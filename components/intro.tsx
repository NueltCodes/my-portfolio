    ...
    >
      ...
      >
        <div className="flex justify-center mb-3">
          <a
            className="group max-w-[450px] justify-center bg-white px-3 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10"
            href="/CV.pdf"
            download
          >
            Certificate from Meta Mobile course{" "}
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-lg font-medium">
          ...
          <a
            ...
            href="https://www.linkedin.com/in/tobi-emmanuel-113392224/"
            target="_blank"
          >
            <BsLinkedin />
          </a>
